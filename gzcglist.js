    ...
    if (type1 == "jmr") {
      switch (type2) {
        case "fs":
          ...
          zschart =
            newHqDomain +
            "api/qt/stock/trends2/get?secid=1.000300&fields1=f1&fields2=f51,f53&ut=b2884a393a59ad64002292a3e90d46a5";
          break;
        default:
          {
            if (type3 == "0") {
            ...
            zschart =
              newHqDomain_K +
              "api/qt/stock/kline/get?secid=1.000300&fields1=f1&fields2=f51,f53&klt=" +
              type2 +
      ...
      switch (type2) {
        case "fs":
          ...
          zschart =
            newHqDomain +
            "api/qt/stock/trends2/get?secid=1.000300&fields1=f1&fields2=f58&ut=b2884a393a59ad64002292a3e90d46a5";
          names = ["", "沪股通", "深股通", "沪深300指数"];
          break;
        default:
          {
